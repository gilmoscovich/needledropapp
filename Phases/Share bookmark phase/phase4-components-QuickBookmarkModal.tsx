...
// Phase 4 version — trackIndex is fully resolved by the hook, no placeholder needed.
// Handles recently-played UI (no timestamp pre-fill, different label).
...
export function QuickBookmarkModal({
  ...
  const handleSave = async () => {
    ...
    const bookmark: Bookmark = {
      ...
      trackIndex: trackInfo.trackIndex,   // fully resolved by Phase 4 hook
...
const styles = StyleSheet.create({
  ...
  tsInputWrapperActive: {
    borderColor: 'rgba(230, 190, 173, 0.3)',   // warm glow when timestamp is auto-filled
  },
  tsInput: {
    flex:    1,
    ...typography.bodyMd,
