...
export function QuickBookmarkModal({
  ...
  // Pre-fill timestamp from API on open
  useEffect(() => {
    if (visible) {
  ...
  const handleSave = async () => {
    ...
    // Phase 2: we use trackIndex 0 as a placeholder for recently-played.
    // Phase 4 will resolve the real trackIndex via getAlbum().
    const trackIndex = trackInfo.needsFullAlbum ? 0 : 0;
